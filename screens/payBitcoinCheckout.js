...
import { Animated, View, Text, SafeAreaView, TouchableOpacity, StyleSheet, StatusBar, ActivityIndicator, Image } from 'react-native';
...
const PayBitcoinCheckoutScreen = ({route, navigation}) => {
            ...
            <SafeAreaView style={{flex: 1}}>
                    ...
                    useNativeDriver={true}>
                        <View style={{justifyContent:'center', alignItems:'center', padding:30}}>
                            <Image source={bitcoinImage} style={{borderRadius:15, height:50, width:50}} />
                        </View>
...
export default PayBitcoinCheckoutScreen;
